  ...
  return (
    <button
      ...
      className={`w-full p-4 text-left transition-all duration-200 ${
        selected 
          ? 'bg-gradient-to-r from-primary-50 to-indigo-50 border-l-4 border-primary-500' 
    ...
    >
      <div className="flex items-center gap-3">
        <div className="relative flex-shrink-0">
          ...
          {isUnread && (
            <span className="absolute -top-0.5 -right-0.5 w-3.5 h-3.5 bg-primary-500 rounded-full border-2 border-white animate-pulse"></span>
          )}
          {conversation.mode === 'ai' && (
            <span className="absolute -bottom-0.5 -right-0.5 w-5 h-5 bg-primary-100 rounded-full flex items-center justify-center border-2 border-white">
        ...
        <div className={`px-4 py-3 rounded-2xl ${
          isOwn 
            ? message.sender_type === 'ai'
              ...
              : 'bg-gradient-to-br from-green-500 to-green-600 text-white rounded-br-md shadow-lg shadow-green-500/20'
  ...
  return (
    <div className="flex-1 flex items-center justify-center p-8">
      <div className="text-center max-w-sm">
        <div className="w-24 h-24 bg-gradient-to-br from-primary-100 to-indigo-100 rounded-3xl flex items-center justify-center mx-auto mb-6">
      ...
      <div className="p-4 border-b border-stone-200 bg-white sticky top-0 z-10">
        ...
        <div className="relative mb-3">
          ...
          <input
            ...
            className="w-full pl-9 pr-4 py-2.5 bg-stone-100 border-2 border-transparent rounded-xl text-sm focus:bg-white focus:border-primary-500 focus:ring-2 focus:ring-primary-500/20 outline-none transition-all"
          />
        </div>
        ...
        <form onSubmit={onSend} className="flex items-end gap-3">
          <div className="flex-1 relative">
            <textarea
              ...
              rows={1}
              className="w-full px-4 py-3 pr-12 bg-stone-100 border-2 border-transparent rounded-2xl resize-none focus:bg-white focus:border-primary-500 focus:ring-2 focus:ring-primary-500/20 outline-none transition-all text-[16px]"
          ...
          <button
            ...
            className="p-3.5 bg-gradient-to-r from-primary-600 to-primary-700 text-white rounded-2xl hover:from-primary-700 hover:to-primary-800 disabled:opacity-50 disabled:cursor-not-allowed transition-all shadow-lg shadow-primary-500/30 hover:shadow-xl hover:-translate-y-0.5 active:translate-y-0 flex-shrink-0"
          >
            {sending ? (
...
function LoadingSkeleton() {
  return (
    <div className="h-[calc(100vh-4rem)] flex items-center justify-center bg-stone-50">
      <div className="text-center">
        <div className="w-16 h-16 bg-gradient-to-br from-primary-100 to-indigo-100 rounded-2xl flex items-center justify-center mx-auto mb-4 animate-pulse">
