    ...
    <div className="min-h-screen bg-[#F2F0E9] flex items-center justify-center">
      <div className="text-center">
        <div className="relative mb-4">
          ...
          <div className="absolute inset-0 w-16 h-16 mx-auto bg-[#2E4036]/20 rounded-full blur-xl animate-pulse" />
        </div>
        <p className="text-[#2E4036]/70 font-medium font-['Plus_Jakarta_Sans']">Loading...</p>
      </div>
    </div>
  );
}
